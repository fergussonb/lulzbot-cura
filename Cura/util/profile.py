...
setting('machine_startup_energy_PLA', '205', float, 'machine', 'hidden').setLabel(_("Warm-up (Wh) -PLA"), _("Startup energy required to run a job"))
setting('machine_run_energy_PLA', '205', float, 'machine', 'hidden').setLabel(_("Average power (W) -PLA"), _("Steady State power usage assuming 70 degrees F room temperature"))
setting('machine_startup_energy_ABS', '205', float, 'machine', 'hidden').setLabel(_("Warm-up (Wh) -ABS"), _("Startup energy required to run a job"))
setting('machine_run_energy_ABS', '205', float, 'machine', 'hidden').setLabel(_("Average power (W) -ABS"), _("Steady State power usage assuming 70 degrees F room temperature"))
setting('machine_startup_energy_HIPS', '205', float, 'machine', 'hidden').setLabel(_("Warm-up (Wh) -HIPS"), _("Startup energy required to run a job"))
setting('machine_run_energy_HIPS', '205', float, 'machine', 'hidden').setLabel(_("Average power (W) -HIPS"), _("Steady State power usage assuming 70 degrees F room temperature"))
setting('machine_startup_energy_PETT', '205', float, 'machine', 'hidden').setLabel(_("Warm-up (Wh) -PETT"), _("Startup energy required to run a job"))
setting('machine_run_energy_PETT', '205', float, 'machine', 'hidden').setLabel(_("Average power (W) -PETT"), _("Steady State power usage assuming 70 degrees F room temperature"))
setting('machine_startup_energy_Nylon', '205', float, 'machine', 'hidden').setLabel(_("Warm-up (Wh) -Nylon"), _("Startup energy required to run a job"))
setting('machine_run_energy_Nylon', '205', float, 'machine', 'hidden').setLabel(_("Average power (W) -Nylon"), _("Steady State power usage assuming 70 degrees F room temperature"))
setting('machine_startup_energy_Other', '205', float, 'machine', 'hidden').setLabel(_("Warm-up (Wh) -Custom"), _("Startup energy required to run a job"))
setting('machine_run_energy_Other', '205', float, 'machine', 'hidden').setLabel(_("Average power (W) -Custom"), _("Steady State power usage assuming 70 degrees F room temperature"))
